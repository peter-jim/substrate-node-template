...
pub mod pallet {
	use frame_support::{dispatch::DispatchResult, pallet_prelude::*,ensure ,debug};
	...
	impl<T:Config> Pallet<T> {
		...
		pub fn transfer(_origin: OriginFor<T>, to: T::AccountId, value: u64) -> DispatchResult {
			...
			//let updated_from_balance:u64 = sender_balance.checked_sub(value).expect("Entire supply fits in u64; qed");
